"""Test packaging metadata stays in sync."""

import tomllib
from pathlib import Path

from naughty_commits import PROGRAM_NAME, PROGRAM_REPO_URL, PROGRAM_VERSION
...
def test_version_lock() -> None:
    ...
    for package in uv_lock.get("package", []):
        ...
        pytest_fail = f"{PROGRAM_NAME} not found in uv.lock"
